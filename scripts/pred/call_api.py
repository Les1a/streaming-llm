...
def get_llm(tokens_to_generate):
    ...
    elif args.server_type == 'longchat_vanilla':
        from model_wrappers import LongChatModel
        llm = LongChatModel(
            name_or_path=args.model_name_or_path,
            do_sample=False,  # args.temperature > 0,
            repetition_penalty=1,
    ...
    elif args.server_type == 'longchat_ours':
        from model_wrappers import OurLongChatModel
        llm = OurLongChatModel(
            name_or_path=args.model_name_or_path,
            do_sample=False,  # args.temperature > 0,
            repetition_penalty=1,
            temperature=0,  # args.temperature,
    ...
    elif args.server_type == 'longchat_streaming':
        from model_wrappers import StreamingLongChatModel
        llm = StreamingLongChatModel(
            name_or_path=args.model_name_or_path,
            do_sample=False,  # args.temperature > 0,
            repetition_penalty=1,
            temperature=0,  # args.temperature,
